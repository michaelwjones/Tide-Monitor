...
if "%choice%"=="1" (
    ...
    echo ✅ Analysis enabled. Installing dependencies and deploying enhanced function...
    ...
    echo ✅ Analysis disabled. Installing dependencies and deploying enhanced function...
    cd tidal-analysis\functions\matrix-pencil\v2
    echo Installing npm dependencies...
    call npm install
    echo Deploying to Firebase...

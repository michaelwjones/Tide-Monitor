...
def fetch_firebase_data():
    ...
    Downloads readings from June 30, 2025 to present for LSTM training.
    """
...
if __name__ == "__main__":
    print("LSTM v1 Data Preparation - Firebase Data Fetcher")
    print("=" * 50)
    ...
    if data:
        ...
        if readings_with_water_level > 0:
            print(f"\nNext step: Run create_training_data.py to process this data for LSTM training")
        else:

...
def create_model(d_model=256, nhead=8, num_layers=6, dropout=0.1):
    ...
    Args:
        ...
        num_layers: Total layers (split between encoder/decoder)
        dropout: Dropout probability
    """
    # Split layers between encoder and decoder (encoder gets more layers)
    num_encoder_layers = max(1, (num_layers * 2) // 3)  # ~67% to encoder
    num_decoder_layers = max(1, num_layers - num_encoder_layers)  # remainder to decoder
